...
module UI
  ...
  module Input
    def get_user_input
      puts "\nThere are 6 possible colors: #{draw_block('green')}, #{draw_block('red')}, #{draw_block('yellow')}, #{draw_block('blue')}, #{draw_block('black')}, #{draw_block('white')}"
      ...
      puts 'A color can only appear once in the code. You have 9 guesses.'
      puts ''
